...
public class Insta_Baseclass {
	public static WebDriver driver;
	public static WebDriver browserlaunch(String browser) {
	try {
		if(browser=="chrome"){
			System.setProperty("webdriver.chrome.driver","C:\\Users\\STORM BREAKER\\eclipse-workspace-oxygen\\Instagram\\src\\test\\resource\\com\\cucumber\\driver\\chromedriver.exe");
